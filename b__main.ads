...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#97cbc870#;
   ...
   u00135 : constant Version_32 := 16#1eeacd0c#;
   pragma Export (C, u00135, "sdlB");
   u00136 : constant Version_32 := 16#6e262465#;
   pragma Export (C, u00136, "sdlS");
   u00137 : constant Version_32 := 16#9f72c855#;
   pragma Export (C, u00137, "sdl__errorB");
   u00138 : constant Version_32 := 16#fbacc442#;
   pragma Export (C, u00138, "sdl__errorS");
   u00139 : constant Version_32 := 16#40f98252#;
   ...
   u00141 : constant Version_32 := 16#07acaf42#;
   pragma Export (C, u00141, "sdl__eventsS");
   u00142 : constant Version_32 := 16#5948638f#;
   pragma Export (C, u00142, "sdl__events__eventsB");
   u00143 : constant Version_32 := 16#5e73368b#;
   pragma Export (C, u00143, "sdl__events__eventsS");
   u00144 : constant Version_32 := 16#f5c36f20#;
   pragma Export (C, u00144, "sdl__events__controllersS");
   u00145 : constant Version_32 := 16#ae71a01b#;
   pragma Export (C, u00145, "sdl__events__joysticksB");
   u00146 : constant Version_32 := 16#e7c77fad#;
   pragma Export (C, u00146, "sdl__events__joysticksS");
   u00147 : constant Version_32 := 16#b782aba3#;
   pragma Export (C, u00147, "sdl__events__filesS");
   u00148 : constant Version_32 := 16#1d599977#;
   pragma Export (C, u00148, "sdl__events__keyboardsB");
   u00149 : constant Version_32 := 16#9106f4b1#;
   pragma Export (C, u00149, "sdl__events__keyboardsS");
   u00150 : constant Version_32 := 16#dff8c4d8#;
   pragma Export (C, u00150, "sdl__videoB");
   u00151 : constant Version_32 := 16#8ca03ec1#;
   pragma Export (C, u00151, "sdl__videoS");
   u00152 : constant Version_32 := 16#c55fea3f#;
   pragma Export (C, u00152, "sdl__video__windowsB");
   u00153 : constant Version_32 := 16#900f1f7d#;
   pragma Export (C, u00153, "sdl__video__windowsS");
   u00154 : constant Version_32 := 16#2fb34529#;
   pragma Export (C, u00154, "system__assertionsB");
   u00155 : constant Version_32 := 16#646ed023#;
   pragma Export (C, u00155, "system__assertionsS");
   u00156 : constant Version_32 := 16#8b2c6428#;
   pragma Export (C, u00156, "ada__assertionsB");
   u00157 : constant Version_32 := 16#cc3ec2fd#;
   pragma Export (C, u00157, "ada__assertionsS");
   u00158 : constant Version_32 := 16#28888d98#;
   pragma Export (C, u00158, "system__finalization_mastersB");
   u00159 : constant Version_32 := 16#02e4eddb#;
   ...
   u00161 : constant Version_32 := 16#bf8c6aef#;
   pragma Export (C, u00161, "system__storage_poolsS");
   u00162 : constant Version_32 := 16#b49a0e5d#;
   pragma Export (C, u00162, "system__storage_pools__subpoolsB");
   u00163 : constant Version_32 := 16#a2d8d50c#;
   pragma Export (C, u00163, "system__storage_pools__subpoolsS");
   u00164 : constant Version_32 := 16#b0df1928#;
   pragma Export (C, u00164, "system__storage_pools__subpools__finalizationB");
   u00165 : constant Version_32 := 16#562129f7#;
   pragma Export (C, u00165, "system__storage_pools__subpools__finalizationS");
   u00166 : constant Version_32 := 16#59a9ef65#;
   pragma Export (C, u00166, "sdl__c_pointersS");
   u00167 : constant Version_32 := 16#dd7f75da#;
   pragma Export (C, u00167, "sdl__video__displaysB");
   u00168 : constant Version_32 := 16#c9623aca#;
   pragma Export (C, u00168, "sdl__video__displaysS");
   u00169 : constant Version_32 := 16#3f16a661#;
   pragma Export (C, u00169, "sdl__video__pixel_formatsB");
   u00170 : constant Version_32 := 16#cad5b75b#;
   pragma Export (C, u00170, "sdl__video__pixel_formatsS");
   u00171 : constant Version_32 := 16#5aa0c2ac#;
   pragma Export (C, u00171, "sdl__video__palettesB");
   u00172 : constant Version_32 := 16#02a22597#;
   pragma Export (C, u00172, "sdl__video__palettesS");
   u00173 : constant Version_32 := 16#7c78c3c5#;
   pragma Export (C, u00173, "system__pool_globalB");
   u00174 : constant Version_32 := 16#91b367a5#;
   ...
   u00177 : constant Version_32 := 16#ef09c5ab#;
   pragma Export (C, u00177, "sdl__video__rectanglesB");
   u00178 : constant Version_32 := 16#773e1129#;
   pragma Export (C, u00178, "sdl__video__rectanglesS");
   u00179 : constant Version_32 := 16#b19e3a91#;
   pragma Export (C, u00179, "sdl__video__surfacesB");
   u00180 : constant Version_32 := 16#888c8957#;
   pragma Export (C, u00180, "sdl__video__surfacesS");
   u00181 : constant Version_32 := 16#e652c197#;
   ...
   u00186 : constant Version_32 := 16#815f70d4#;
   pragma Export (C, u00186, "system__fat_fltS");
   u00187 : constant Version_32 := 16#a76d79d9#;
   pragma Export (C, u00187, "system__fat_lfltS");
   u00188 : constant Version_32 := 16#ddbdd733#;
   pragma Export (C, u00188, "system__fat_llfS");
   u00189 : constant Version_32 := 16#66035241#;
   pragma Export (C, u00189, "sdl__events__miceS");
   u00190 : constant Version_32 := 16#446ed451#;
   pragma Export (C, u00190, "sdl__events__touchesS");
   u00191 : constant Version_32 := 16#713bfc83#;
   pragma Export (C, u00191, "sdl__events__windowsS");
   u00192 : constant Version_32 := 16#48176494#;
   pragma Export (C, u00192, "sdl__imagesB");
   u00193 : constant Version_32 := 16#530d5180#;
   pragma Export (C, u00193, "sdl__imagesS");
   u00194 : constant Version_32 := 16#34c5a405#;
   pragma Export (C, u00194, "sdl__images__ioB");
   u00195 : constant Version_32 := 16#9a728871#;
   pragma Export (C, u00195, "sdl__images__ioS");
   u00196 : constant Version_32 := 16#ebda439b#;
   pragma Export (C, u00196, "sdl__rwopsB");
   u00197 : constant Version_32 := 16#82fbb5ae#;
   pragma Export (C, u00197, "sdl__rwopsS");
   u00198 : constant Version_32 := 16#f5f567e3#;
   pragma Export (C, u00198, "sdl__video__renderersB");
   u00199 : constant Version_32 := 16#a0ad70f6#;
   pragma Export (C, u00199, "sdl__video__renderersS");
   u00200 : constant Version_32 := 16#580ccfdc#;
   pragma Export (C, u00200, "sdl__video__texturesB");
   u00201 : constant Version_32 := 16#abea9c79#;
   pragma Export (C, u00201, "sdl__video__texturesS");
   u00202 : constant Version_32 := 16#71581158#;
   pragma Export (C, u00202, "sdl__video__pixelsS");
   u00203 : constant Version_32 := 16#010b3ca4#;
   pragma Export (C, u00203, "sdl__video__renderers__makersB");
   u00204 : constant Version_32 := 16#9b55209d#;
   pragma Export (C, u00204, "sdl__video__renderers__makersS");
   u00205 : constant Version_32 := 16#1aa788ac#;
   pragma Export (C, u00205, "sdl__video__surfaces__makersB");
   u00206 : constant Version_32 := 16#7aec1d50#;
   pragma Export (C, u00206, "sdl__video__surfaces__makersS");
   u00207 : constant Version_32 := 16#6b6cf7a1#;
   pragma Export (C, u00207, "sdl__video__textures__makersB");
   u00208 : constant Version_32 := 16#bee99f6d#;
   pragma Export (C, u00208, "sdl__video__textures__makersS");
   u00209 : constant Version_32 := 16#6a50b071#;
   pragma Export (C, u00209, "sdl__video__windows__makersB");
   u00210 : constant Version_32 := 16#49567878#;
   pragma Export (C, u00210, "sdl__video__windows__makersS");
   u00211 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00211, "system__concat_2B");
   u00212 : constant Version_32 := 16#f796dc4f#;
